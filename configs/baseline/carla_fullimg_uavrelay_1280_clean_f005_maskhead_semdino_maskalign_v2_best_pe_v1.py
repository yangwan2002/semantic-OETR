...
cfg.OUTPUT = 'carla_fullimg_uavrelay_1280_clean_f005_maskhead_semdino_maskalign_v2_best_pe_v1'
...
# current_best + PE:
# keep the current strongest semantic+mask setup unchanged and only enable
# scale-adaptive position encoding for a controlled PE ablation.
cfg.OETR.CHECKPOINT = (
    r'/root/autodl-tmp/semantic-OETR/OUTPUT/OETR/checkpoints/'
    r'carla_fullimg_uavrelay_1280_clean_f005_maskhead_semdino_maskalign_v2_best/06-03-17:02/'
    r'model_epoch_11.pth'
)
