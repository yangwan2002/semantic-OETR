...
cfg.OUTPUT = 'carla_fullimg_uavrelay_soft_planar_finetune_pe'
...
# Fine-tune maskalign_v2_best on soft+planar GT, with PE enabled (same as pe_v1 ablation).
cfg.OETR.CHECKPOINT = (
...
cfg.DATASET.TRAIN.LIST_PATH = (
    r'/root/autodl-tmp/CARLA-Air-demo/AirGroundRelay-Sim/sequences/'
    r'paper_eval_l2_sem_rich_20260531_174329/'
    r'oetr_fullimage_uavrelay_soft_planar_clean_f005/pairs_train.jsonl'
)
...
cfg.DATASET.VAL.LIST_PATH = (
    r'/root/autodl-tmp/CARLA-Air-demo/AirGroundRelay-Sim/sequences/'
    r'paper_eval_l2_sem_rich_20260531_174329/'
    r'oetr_fullimage_uavrelay_soft_planar_clean_f005/pairs_val.jsonl'
)
