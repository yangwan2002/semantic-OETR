...
cfg.OUTPUT = 'carla_fullimg_uavrelay_1280_clean_f005_maskhead_semdino_maskalign_v2_best'
...
# Best-performance semantic run:
# 1. warm start from the strongest current mask baseline
# 2. train the mask head with predicted-box priors instead of GT-box priors
# 3. weaken the prior injection so the semantic/mask branch learns to recover
#    overlap shape instead of copying the coarse box
cfg.OETR.CHECKPOINT = (
    r'/root/autodl-tmp/semantic-OETR/OUTPUT/OETR/checkpoints/'
    r'carla_fullimg_uavrelay_1280_clean_f005_maskhead_v2_lr2e5/06-03-13:20/'
    r'model_epoch_7.pth'
)
...
cfg.DATASET.TRAIN.LIST_PATH = (
    r'/root/autodl-tmp/CARLA-Air-demo/AirGroundRelay-Sim/sequences/'
    r'paper_eval_l2_sem_rich_20260531_174329/'
    r'oetr_fullimage_uavrelay_clean_f005/pairs_train.jsonl'
)
...
cfg.DATASET.VAL.LIST_PATH = (
    r'/root/autodl-tmp/CARLA-Air-demo/AirGroundRelay-Sim/sequences/'
    r'paper_eval_l2_sem_rich_20260531_174329/'
    r'oetr_fullimage_uavrelay_clean_f005/pairs_val.jsonl'
)
